...
$configs= array(
    //"LOAD_EXT_FILE"=>"alipay_core,alipay_md5",//拓展自定义函数库文件
        ...
        'DEFAULT_FILTER'        =>  'trim,htmlspecialchars', // 默认参数过滤方法 用于I函数...htmlspecialchars
        ...
        'NEWS_AUTHOR'=>'华创在线',
        'OFFER_AUTHOR'=>'华创在线科技有限公司',
        'DATAERROR'=>'数据错误，请刷新重试',
        'OUTTIME'=>3600,
        /******** 支付宝支付配置 ********/
    'ALIPAY_CONFIG'=>array(
        ...
        "notify_url"=>"http://hcpro.wincomtech.cn/Portal/Alipay/notify0.php",//服务器异步通知页面路径
        "return_url"=>"http://hcpro.wincomtech.cn/Portal/Alipay/return0.php",//页面跳转同步通知页面路径
